...
class FetchJobDetails:
    ...
    def navigate_to(self, driver, url, sleep_time=2):
    ...
    def get_job_details(self):
        ...
        def get_single_job(page_num, page_url, sleep_time=2):
            # get driver
        ...
        for page_num in range(self.num_pages_to_crawl):
            ...
            if page_num == 0:
                ...
                job_details = get_single_job(page_num+1, page_url)
                ...
                job_details = get_single_job(next_page_start, page_url)
                for a_job in job_details:
                    all_jobs.append(a_job)
